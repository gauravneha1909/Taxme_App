...
import com.example.gplusin.adapter.AdapterAdhocWorkHoursdetail;
...
public class AdhocWorkDetaileHistory extends AppCompatActivity {

    ProgressDialog dialog;

    User user;
    ActivityAdhocDetaileHistoryBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adhoc_detaile_history);
        binding = ActivityAdhocDetaileHistoryBinding.inflate(getLayoutInflater());
...
// finally change the color
        ...
        dialog = new ProgressDialog(AdhocWorkDetaileHistory.this);
        dialog.setMessage("Please Wait...");
        user=new User(AdhocWorkDetaileHistory.this);


        binding.addleave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AdhocWorkDetaileHistory.this, AdhocworkhourActivity.class));
            }
        });
    ...
    private void callhistoricaldata() {
        ...
        apiServise.adhoc_work_hoursfromid(user.getUserid())
                .enqueue( new Callback<Adhoc_work_hoursOne>() {
                    @Override
                    public void onResponse(Call<Adhoc_work_hoursOne> call, Response<Adhoc_work_hoursOne> response) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (response.body().result.size() > 0) {
                                ...
                                binding.featureproduct.setAdapter( new AdapterAdhocWorkHoursdetail( AdhocWorkDetaileHistory.this,response.body().result ) );
                    ...
                    @Override
                    public void onFailure(Call<Adhoc_work_hoursOne> call, Throwable t) {
                        dialog.cancel();
...
//                {
//                    binding.featureproduct.setVisibility(View.VISIBLE);
//                    binding.featureproduct.setAdapter( new AdapterAdhocWorkHoursdetail( AdhocWorkDetaileHistory.this,fcmUsers ) );
//
//                }else
//                {
