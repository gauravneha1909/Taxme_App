...
public class AdhocIncomeAdd extends AppCompatActivity {
    ActivityAdhocIncomeAddBinding binding;
    ...
    // https://www.geeksforgeeks.org/show-pdf-using-intent-in-android/


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_adhoc_income_add);

        binding = ActivityAdhocIncomeAddBinding.inflate(getLayoutInflater());
...
// finally change the color
        ...
        dialog = new ProgressDialog(AdhocIncomeAdd.this);
        dialog.setMessage("Please Wait...");
        user=new User(AdhocIncomeAdd.this);
...
//                                            + sPath));
        ...
        binding.firstpaymentdateline.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                newFragment.show(AdhocIncomeAdd.this.getSupportFragmentManager(), "datePicker");
        ...
        binding.submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (binding.incomeSource.getText().toString().isEmpty()) {
                    Toast.makeText(AdhocIncomeAdd.this, "Enter Income Source", Toast.LENGTH_SHORT ).show();
                    return;
                }

                if (binding.incomeAmount.getText().toString().isEmpty()) {
                    Toast.makeText(AdhocIncomeAdd.this, "Enter Income Amount", Toast.LENGTH_SHORT ).show();
                    return;
                }

                if (taxreducesourceString.equals("")) {
                    Toast.makeText(AdhocIncomeAdd.this, "Select Tax Deducted at Source", Toast.LENGTH_SHORT ).show();
                    return;
                }


                if (binding.taxReduce.getText().toString().isEmpty()) {
                    Toast.makeText(AdhocIncomeAdd.this, "Enter Tax Reduce", Toast.LENGTH_SHORT ).show();
                    return;
                }


                if (firstpaymentdate.equals("")) {
                    Toast.makeText(AdhocIncomeAdd.this, "Select Adhoc Income Date", Toast.LENGTH_SHORT ).show();
                    return;
                }
...
//                startService(intent);
    ...
    private void selectimagetype() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder( AdhocIncomeAdd.this );
...
//                        @Override
//                        public void onPermissionGranted() {
//                            TedBottomPicker.with( AdhocIncomeAdd.this )
//                                    //.setPeekHeight(getResources().getDisplayMetrics().heightPixels/2)
//                                    .setSelectedUri( selectFileUri1 )
//                                    //.showVideoMedia()
//                                    .setPeekHeight( 1200 )
...
//                    binding.gstAmount.setFocusableInTouchMode(true);
                    ...
                    binding.taxReduce.setText(null);
...
//        TedPermission.with( AdhocIncomeAdd.this)
        ...
        uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                if (task.isSuccessful()){
                    ...
                    dialog.cancel();
                    Toast.makeText(AdhocIncomeAdd.this, "Failed!", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(AdhocIncomeAdd.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                dialog.cancel();
            }
        });
                    ...
                    public void onResponse(Call<RegisterData> call, Response<RegisterData> response) {
                        ...
                        if (response.isSuccessful()) {
                            if (response.body().getResult().equals( "Success" )) {
                                ...
                                Toast.makeText(AdhocIncomeAdd.this, "Success", Toast.LENGTH_SHORT).show();
                                onBackPressed();

                            } else {
                                Toast.makeText(AdhocIncomeAdd.this, response.body().getResult(), Toast.LENGTH_SHORT).show();
                            }
                        } else {
