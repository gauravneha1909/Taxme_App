...
import com.example.gplusin.databinding.ActivityBusinessExpenseAddBinding;
...
public class Business_expense_Add extends AppCompatActivity {

    ActivityBusinessExpenseAddBinding binding;
    ...
    MultipartBody.Part imageorpdfmultipart=null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_business_expense_add);

        binding = ActivityBusinessExpenseAddBinding.inflate(getLayoutInflater());
...
// finally change the color
        ...
        storageReference= FirebaseStorage.getInstance().getReference("Business_expense_proof_image");

        dialog = new ProgressDialog(Business_expense_Add.this);
        dialog.setMessage("Please Wait...");
        user=new User(Business_expense_Add.this);
...
//                                            + sPath));
        ...
        binding.firstpaymentdateline.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                newFragment.show(Business_expense_Add.this.getSupportFragmentManager(), "datePicker");
        ...
        binding.submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (binding.expenseName.getText().toString().isEmpty()) {
                    Toast.makeText(Business_expense_Add.this, "Enter Expense Name", Toast.LENGTH_SHORT ).show();
                    return;
                }

                if (binding.expenseAmount.getText().toString().isEmpty()) {
                    Toast.makeText(Business_expense_Add.this, "Enter Expense Amount", Toast.LENGTH_SHORT ).show();
                    return;
                }

                if (taxreducesourceString.equals("")) {
                    Toast.makeText(Business_expense_Add.this, "Select Is GST Paid?", Toast.LENGTH_SHORT ).show();
                    return;
                }


                if (binding.gstAmount.getText().toString().isEmpty()) {
                    Toast.makeText(Business_expense_Add.this, "Enter GST Amount", Toast.LENGTH_SHORT ).show();
                    return;
                }

                if (binding.claimableGst.getText().toString().isEmpty()) {
                    Toast.makeText(Business_expense_Add.this, "Enter Claimable GST", Toast.LENGTH_SHORT ).show();
                    return;
                }

                if (firstpaymentdate.equals("")) {
                    Toast.makeText(Business_expense_Add.this, "Select Business expense Date", Toast.LENGTH_SHORT ).show();
                    return;
                }
...
//                checkPermission( permissionListener );
    ...
    private void selectimagetype() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder( Business_expense_Add.this );
...
//                        @Override
//                        public void onPermissionGranted() {
//                            TedBottomPicker.with( Business_expense_Add.this )
//                                    //.setPeekHeight(getResources().getDisplayMetrics().heightPixels/2)
//                                    .setSelectedUri( selectFileUri1 )
//                                    //.showVideoMedia()
//                                    .setPeekHeight( 1200 )
...
//                    binding.gstAmount.setFocusableInTouchMode(true);
                    ...
                    binding.gstAmount.setText(null);
...
//    }
    ...
    private void uploadimagemutipartfromimage(){

        File file=new File(String.valueOf(selectFileUri1));

        imageorpdfmultipart = MultipartBody.Part.createFormData( "image", file.getPath(), RequestBody.create( MediaType.parse( "multipart/form-data" ), file ) );
        ...
        uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                if (task.isSuccessful()){
                    ...
                    dialog.cancel();
                    Toast.makeText(Business_expense_Add.this, "Failed!", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Business_expense_Add.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                dialog.cancel();
            }
        });
    ...
    private void uploadimage(String mUri) {
        ...
        room.put("ExpenseID", "1");
        room.put("image", mUri);
        room.put("image_type", uploadtype);
        room.put("pdfname", pdfname);
        room.put("ExpenseDate", firstpaymentdate);
        room.put("action", "1");
                    ...
                    public void onResponse(Call<RegisterData> call, Response<RegisterData> response) {
                        ...
                        if (response.isSuccessful()) {
                            if (response.body().getResult().equals( "Success" )) {
                                ...
                                Toast.makeText(Business_expense_Add.this, "Success", Toast.LENGTH_SHORT).show();
                                onBackPressed();

                            } else {
                                Toast.makeText(Business_expense_Add.this, response.body().getResult(), Toast.LENGTH_SHORT).show();
                            }
                        } else {
