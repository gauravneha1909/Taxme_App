...
import com.example.gplusin.databinding.ActivityLeaveUpdateBinding;
...
public class LeaveActivityUpdate extends AppCompatActivity {

    ActivityLeaveUpdateBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLeaveUpdateBinding.inflate(getLayoutInflater());
...
// finally change the color
        ...
        dialog = new ProgressDialog(LeaveActivityUpdate.this);
        dialog.setMessage("Please Wait...");
        user=new User(LeaveActivityUpdate.this);
        ...
        binding.startdateline.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (employeenamstartdate.equals("")) {
                    Toast.makeText(LeaveActivityUpdate.this, "Select Employment Name", Toast.LENGTH_SHORT ).show();
                    return;
                }
...
//                getDatesBetween(startdate,enddate)
                ...
                newFragment.show(LeaveActivityUpdate.this.getSupportFragmentManager(), "datePicker");
        ...
        binding.employeenddateline.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (startdate.equals("")) {
                    Toast.makeText(LeaveActivityUpdate.this, "Select Start Date", Toast.LENGTH_SHORT ).show();
                    return;
                }
...
//        getDatesBetween("03/23/2023","03/28/2023");
    ...
    private void sevefirebasedata(String data,String totaldays) {
       ...
       String key=Common.updateleavedetaile.keyid;
        Log.e("bvxbvx",key);
...
//        room.put("action", "2" );
        ...
        apiServise.leave_daysUpdate(room)
                    ...
                    public void onResponse(Call<RegisterData> call, Response<RegisterData> response) {
                        ...
                        if (response.isSuccessful()) {
                            if (response.body().getResult().equals( "Success" )) {
                                ...
                                Toast.makeText(LeaveActivityUpdate.this, "Success", Toast.LENGTH_SHORT).show();
                                onBackPressed();

                            } else {
                                Toast.makeText(LeaveActivityUpdate.this, response.body().getResult(), Toast.LENGTH_SHORT).show();
                            }
                        } else {
...
//                .child(typechild)
            ...
            public void onDataChange(@NonNull @org.jetbrains.annotations.NotNull DataSnapshot snapshot) {
                ...
                if(fcmUsers.size()>0)
                {
                    ...
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(LeaveActivityUpdate.this);
...
//                 Log.e("mnxmnx",datafinal);
                ...
                }else
                {
                    ...
                    Toast.makeText(LeaveActivityUpdate.this, "Data Not Found", Toast.LENGTH_SHORT).show();
