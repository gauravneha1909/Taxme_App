...
import com.example.gplusin.fragment.leave.LeaveActivityUpdate;
...
public class AdapterLeavedetail extends RecyclerView.Adapter<AdapterLeavedetail.MyViewHolder> {
    Context context;

    View view;
    ArrayList<LeaveDataHistory> amnsm=new ArrayList<>();

  //  Updateemployeedetail updateemployeedetail;



    public AdapterLeavedetail(Context context, ArrayList<LeaveDataHistory> amnsm) {
    ...
    @NonNull
    @Override
    public AdapterLeavedetail.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view= LayoutInflater.from( context ).inflate( R.layout.employeeitem_leave,parent,false );
        return new AdapterLeavedetail.MyViewHolder( view );
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterLeavedetail.MyViewHolder holder, int position) {
       ...
       // holder.txtMessage3.setText("End Date:  "+amnsm.get( position ).enddate);
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setMessage( "Deleting this Leave will remove its data from Projection. Do you want to edit instead?" );
        ...
        holder.update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                context.startActivity(new Intent(context, LeaveActivityUpdate.class));
            }
        });
    ...
    private void deleteelement(LeaveDataHistory leaveDataHistory, int position) {
        ...
        room.put("leave_json_id", leaveDataHistory.keyid);
//        room.put("action", "3");
        ...
        apiServise.leave_daysdelete(room)
...
//                    Toast.makeText(context, "Delete Success", Toast.LENGTH_SHORT).show();
            ...
            Query applesQuery = ref
                    ...
                    .child("leave_days").child(keyid);  //.orderByChild("keyid").equalTo(amnsm.get(position).keyid)
